...
//this class from https://code.luasoftware.com/tutorials/android/page-indicator-for-recyclerview/
class CirclePagerIndicatorDecoration(private var context: Context) : RecyclerView.ItemDecoration() {

    private val colorActive = context.getColor(R.color.colorPrimaryDark)
    private val colorInactive = context.getColor(R.color.white)
